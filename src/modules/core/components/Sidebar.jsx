...
export default function Sidebar() {
  ...
  return (
    <div>
        <nav className="bg-white h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] tracking-wide overflow-auto mt-24">
      <div className="flex flex-wrap items-center gap-4 cursor-pointer">
        <img src='https://readymadeui.com/profile.webp' className="w-10 h-10 rounded-full border-2 border-black" />
        <div>
      ...
      <ul className="space-y-3">
        <li>
          <Link to="dashboard" className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
        ...
        <li>
          <Link to="createorder" className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
        ...
        <li>
        <Link to="myemployee" className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4" viewBox="0 0 16 16">
              <path
                d="M13 .5H3A2.503 2.503 0 0 0 .5 3v10A2.503 2.503 0 0 0 3 15.5h10a2.503 2.503 0 0 0 2.5-2.5V3A2.503 2.503 0 0 0 13 .5ZM14.5 13a1.502 1.502 0 0 1-1.5 1.5H3A1.502 1.502 0 0 1 1.5 13v-.793l3.5-3.5 1.647 1.647a.5.5 0 0 0 .706 0L10.5 7.207V8a.5.5 0 0 0 1 0V6a.502.502 0 0 0-.5-.5H9a.5.5 0 0 0 0 1h.793L7 9.293 5.354 7.647a.5.5 0 0 0-.707 0L1.5 10.793V3A1.502 1.502 0 0 1 3 1.5h10A1.502 1.502 0 0 1 14.5 3Z"
                data-original="#000000" />
        ...
        <li>
        <Link to="orderapproval" className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4" viewBox="0 0 16 16">
              <path
                d="M13 .5H3A2.503 2.503 0 0 0 .5 3v10A2.503 2.503 0 0 0 3 15.5h10a2.503 2.503 0 0 0 2.5-2.5V3A2.503 2.503 0 0 0 13 .5ZM14.5 13a1.502 1.502 0 0 1-1.5 1.5H3A1.502 1.502 0 0 1 1.5 13v-.793l3.5-3.5 1.647 1.647a.5.5 0 0 0 .706 0L10.5 7.207V8a.5.5 0 0 0 1 0V6a.502.502 0 0 0-.5-.5H9a.5.5 0 0 0 0 1h.793L7 9.293 5.354 7.647a.5.5 0 0 0-.707 0L1.5 10.793V3A1.502 1.502 0 0 1 3 1.5h10A1.502 1.502 0 0 1 14.5 3Z"
                data-original="#000000" />
        ...
        <li>
          <Link to="term&condition" className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
              viewBox="0 0 512 512">
              <path
        ...
        <li>
          <Link to="orderhistory" className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
        ...
        <li>
          <Link to="inbox" className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
        ...
        <li>
          <Link to="return" className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
        ...
        <li>
          <Link to="profile" className="text-black text-sm flex items-center hover:bg-gray-700 rounded px-4 py-3 transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
              viewBox="0 0 512 512">
              <path
