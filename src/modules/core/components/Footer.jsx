...
export default function Footer() {
  return (
        ...
        <footer className="bg-gray-900 p-10 font-[sans-serif] tracking-wide w-[165vh] ml-auto ">
      ...
      <p className='text-gray-300 text-sm mt-10 text-center'>© ABES Web Team. All rights reserved.
      </p>
    </footer>
